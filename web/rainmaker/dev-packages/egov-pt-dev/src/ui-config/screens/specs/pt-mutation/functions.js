        ...
        downloadMenu: {
          ...
          props: {
            data: {
              ...
              props: { variant: "outlined", style: { height: "60px", color: "#2947a3", marginRight: "5px" }, className: "pt-download-button" },
              menu: downloadMenu
            }
          }
        },
        printMenu: {
          ...
          props: {
            data: {
              ...
              leftIcon: "print",
              rightIcon: "arrow_drop_down",
              props: { variant: "outlined", style: { height: "60px", color: "#2947a3" }, className: "pt-print-button" },
              menu: printMenu
            }
          }
        }
