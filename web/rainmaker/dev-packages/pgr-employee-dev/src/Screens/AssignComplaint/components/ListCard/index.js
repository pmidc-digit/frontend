  ...
  changeClickedItem = (dataSource, id) => {
    ...
    for (var i = 0; i < dataSource.length; i++) {
      ...
      if (dataSource[i].id === id) {
        dataSource[i] = {
          ...dataSource[i],
          style: { background: "#f8f8f8", borderLeft: "3px solid #2947a3" },
          leftAvatar: (
            <div className="avatar-selected" style={{ width: 33, height: 33, background: "#2947a3", borderRadius: "50%", top: 8, left: 17 }}>
