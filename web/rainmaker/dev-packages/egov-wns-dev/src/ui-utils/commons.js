...
import { getTenantIdCommon, getUserInfo, getLocale, getLocalization, getAppid, getIPin, getThirdPartyURL, getThirdPartyName } from "egov-ui-kit/utils/localStorageUtils";
...
const parserFunction = (state) => {
    ...
    let parsedObject = {
        ...
        additionalDetails: {
            // First, copy all existing additionalDetails fields
            ...(queryObject.additionalDetails || {}),
            // Then override/transform specific fields
            initialMeterReading: (
            ...
            isexempted: queryObject.additionalDetails && queryObject.additionalDetails.isexempted !== undefined ? queryObject.additionalDetails.isexempted : false,
            ...
            avarageMeterReading: queryObject && queryObject.additionalDetails && queryObject.additionalDetails.avarageMeterReading ? parseFloat(queryObject.additionalDetails.avarageMeterReading) : null,
            meterMake: queryObject && queryObject.additionalDetails && queryObject.additionalDetails.meterMake ? parseFloat(queryObject.additionalDetails.meterMake) : null,
            compositionFee: queryObject && queryObject.additionalDetails && queryObject.additionalDetails.compositionFee ? parseFloat(queryObject.additionalDetails.compositionFee) : null,
            compositionFeesw: queryObject && queryObject.additionalDetails && queryObject.additionalDetails.compositionFeesw ? parseFloat(queryObject.additionalDetails.compositionFeesw) : null,
            userCharges: queryObject && queryObject.additionalDetails && queryObject.additionalDetails.userCharges ? parseFloat(queryObject.additionalDetails.userCharges) : null,
            userChargessw: queryObject && queryObject.additionalDetails && queryObject.additionalDetails.userChargessw ? parseFloat(queryObject.additionalDetails.userChargessw) : null,
            othersFee: queryObject && queryObject.additionalDetails && queryObject.additionalDetails.othersFee ? parseFloat(queryObject.additionalDetails.othersFee) : null,
            othersFeesw: queryObject && queryObject.additionalDetails && queryObject.additionalDetails.othersFeesw ? parseFloat(queryObject.additionalDetails.othersFeesw) : null,
            ...
            adhocPenalty: queryObject && queryObject.additionalDetails && queryObject.additionalDetails.adhocPenalty !== undefined ? queryObject.additionalDetails.adhocPenalty : null,
            adhocPenaltyComment: queryObject && queryObject.additionalDetails && queryObject.additionalDetails.adhocPenaltyComment !== undefined ? queryObject.additionalDetails.adhocPenaltyComment : null,
            adhocPenaltyReason: queryObject && queryObject.additionalDetails && queryObject.additionalDetails.adhocPenaltyReason !== undefined ? queryObject.additionalDetails.adhocPenaltyReason : null,
            adhocRebate: queryObject && queryObject.additionalDetails && queryObject.additionalDetails.adhocRebate !== undefined ? queryObject.additionalDetails.adhocRebate : null,
            adhocRebateComment: queryObject && queryObject.additionalDetails && queryObject.additionalDetails.adhocRebateComment !== undefined ? queryObject.additionalDetails.adhocRebateComment : null,
            adhocRebateReason: queryObject && queryObject.additionalDetails && queryObject.additionalDetails.adhocRebateReason !== undefined ? queryObject.additionalDetails.adhocRebateReason : null,
