    ...
    case "Paid":
      return (
        <div>
          ...
          <div className="assessment-displayInline" style={{ color: '#2947a3' }} onClick={() => downloadReceipt(tenantId, consumerCode,businessService)}>
    ...
    case "Saved Draft":
      return (
        <div>
          ...
          <div className="assessment-displayInline" style={{ paddingTop: "10px", color: '#2947a3' }} onClick={() => downloadReceipt(tenantId, consumerCode)}>
            {/* <Link to="home" style={{ color: '#2947a3' }}> */}
            <LabelContainer labelKey="WS_COMMON_BUTTON_DOWNLOAD_RECEIPT" />
            {/* </Link> */}
          </div>
        </div>
