        ...
        downloadMenu: {
          ...
          props: {
            data: {
              ...
              props: { variant: "outlined", style: { height: "60px", color: "#2947a3", maxWidth: "95%", marginRight: "-15px" }, className: "tl-download-button" },
              menu: downloadMenu
            }
          }
        },
        printMenu: {
          ...
          props: {
            data: {
              ...
              leftIcon: "print",
              rightIcon: "arrow_drop_down",
              props: { variant: "outlined", style: { height: "60px", color: "#2947a3", maxWidth: "85%" }, className: "tl-print-button" },
              menu: printMenu
            }
          }
        }
