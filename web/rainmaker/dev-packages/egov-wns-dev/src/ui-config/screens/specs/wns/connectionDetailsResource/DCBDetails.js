...
export const totalRow3 = () => {
  return (
    getCommonContainer({
      ...
      taxBalance: getLabelOnlyValueforColumnData({
        jsonPath: "dcbtotalDetails[0].totalBalance",
        callBack: (value) => handleAmount(Math.abs(Number(value || 0))),
      }),
