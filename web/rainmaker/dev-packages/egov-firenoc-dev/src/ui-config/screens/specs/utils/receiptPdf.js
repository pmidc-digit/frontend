  ...
  switch (type) {
    ...
    case "receipt":
      ...
      qrText = `Application: ${transformedData.applicationNumber
        }, Receipt number: ${transformedData.receiptNumber}, Date of payment: ${transformedData.paymentDate
        }, Fees Paid: ${transformedData.amountPaid}, Payment mode: ${transformedData.paymentMode
...
const newgetApplicationData = async (transformedData, ulbLogo, type) => {
  ...
  let buildingString = "";
  if (transformedData.buildings.length > 1) {
    buildingString = transformedData.buildings.map(b => b.name).join(", ");
  } else if (transformedData.buildings.length === 1) {
    buildingString = transformedData.buildings[0].name;
  }
  ...
  let qrText = `Application: ${transformedData.applicationNumber}, Date: ${transformedData.applicationDate
    }, Buildings: ${transformedData.propertyType}, Applicant: ${transformedData.owners[0].name
    }, Address: ${transformedData.address}`;
...

      {
        ...
        table: {
          ...
          body: [
            ...
            [
              {
                text: ["                        ਤਸਦੀਕ ਕੀਤਾ ਜਾਂਦਾ ਹੈ ਕ‌ਿ ", { text: `${buildingString}`, bold: true }, ", ", { text: `${transformedData.address}`, bold: true }, " ਸਮੇਤ ", { text: `${transformedData.buildings[0].uoms.NO_OF_BASEMENTS}` ? `${transformedData.buildings[0].uoms.NO_OF_BASEMENTS}` : '0', bold: true }, " ਬੇਸਮਟ ਅਤੇ ", { text: `${transformedData.buildings[0].uoms.NO_OF_FLOORS}`, bold: true }, " (ਉਪਰਲੀ ਮੰਜ਼ਿਲ) ਮਲਕੀਅਤ/ਕਬਜ਼ਾਦਾਰ ", { text: `${transformedData.owners[0].name}`, bold: true }, " ਰਾਸ਼ਟਰੀ ਬਿਲਡਿੰਗ ਕੋਡ ਅਨੁਸਾਰ ਅੱਗ ਬੁਝਾਉਣ ਦੇ ਪ੍ਰਭਾਵ ਅਤੇ ਬਚਾਅ ਦੀਆਂ ਲੌੜਾਂ ਨੂੰ ਪੂਰਾ ਕਰਦੀ ਹੈ  ਜਿਸ ਨੂੰ ਸਬੰਧਤ ਫਾਇਰ ਅਧਿਕਾਰੀ ਵੱਲੌਂ ", { text: `${transformedData.owners[0].name}`, bold: true }, " (ਮਾਲਕ ਜਾਂ ਉਸ ਦੇ ਪ੍ਰਤਿਨਿਧੀ ਦਾ ਨਾਮ ) ਦੀ ਮੋਜੂਦਗੀ ਵਿੱਚ ", { text: `${transformedData.issuedDate}`, bold: true }, " ਨੂੰ ਪ੍ਰਮਾਣਿਤ ਕੀਤਾ ਗਿਆ ਅਤੇ ਇਮਾਰਤ / ਬਿਲਡਿੰਗ ", { text: `${transformedData.NBCGroup}`, bold: true }, " subdivision ", { text: `${transformedData.NBCSubGroup}`, bold: true }, " (ਐਨ. ਬੀ. ਸੀ. ਦੇ ਅਨੁਸਾਰ) ਦੀ ਆਬਾਦੀ ਲਈ Issue date ਤੌਂ ", { text: `${validityYears} ਸਾਲ`, bold: true }, " ਤੱਕ ਯੋਗ ਹੈ ਜਿਸ ਲਈ ਨਿਮਨ ਅਨੁਸਾਰ ਹਦਾਇਤਾਂ ਹਨ।"],
                border: [true, false, true, false],
                alignment: "justify",
                preserveLeadingSpaces: true
...

      {
        ...
        table: {
          ...
          body: [
            ...
            [
              {
                text: ["                        ਤਸਦੀਕ ਕੀਤਾ ਜਾਂਦਾ ਹੈ ਕ‌ਿ ", { text: `${buildingString}`, bold: true }, ", ", { text: `${transformedData.address}`, bold: true }, " ਸਮੇਤ ", { text: `${transformedData.buildings[0].uoms.NO_OF_BASEMENTS}` ? `${transformedData.buildings[0].uoms.NO_OF_BASEMENTS}` : '0', bold: true }, " ਬੇਸਮਟ ਅਤੇ ", { text: `${transformedData.buildings[0].uoms.NO_OF_FLOORS}`, bold: true }, " (ਉਪਰਲੀ ਮੰਜ਼ਿਲ) ਮਲਕੀਅਤ/ਕਬਜ਼ਾਦਾਰ ", { text: `${transformedData.buildings[0].name}`, bold: true }, " ਰਾਸ਼ਟਰੀ ਬਿਲਡਿੰਗ ਕੋਡ ਅਨੁਸਾਰ ਅੱਗ ਬੁਝਾਉਣ ਦੇ ਪ੍ਰਭਾਵ ਅਤੇ ਬਚਾਅ ਦੀਆਂ ਲੌੜਾਂ ਨੂੰ ਪੂਰਾ ਕਰਦੀ ਹੈ  ਜਿਸ ਨੂੰ ਸਬੰਧਤ ਫਾਇਰ ਅਧਿਕਾਰੀ ਵੱਲੌਂ ", { text: `${transformedData.owners[0].name}`, bold: true }, " (ਮਾਲਕ ਜਾਂ ਉਸ ਦੇ ਪ੍ਰਤਿਨਿਧੀ ਦਾ ਨਾਮ ) ਦੀ ਮੋਜੂਦਗੀ ਵਿੱਚ ", { text: `${transformedData.issuedDate}`, bold: true }, " ਨੂੰ ਪ੍ਰਮਾਣਿਤ ਕੀਤਾ ਗਿਆ ਅਤੇ ਇਮਾਰਤ / ਬਿਲਡਿੰਗ ", { text: `${transformedData.NBCGroup}`, bold: true }, " subdivision ", { text: `${transformedData.NBCSubGroup}`, bold: true }, " (ਐਨ. ਬੀ. ਸੀ. ਦੇ ਅਨੁਸਾਰ) ਦੀ ਆਬਾਦੀ ਲਈ Issue date ਤੌਂ ", { text: `${validityYears} ਸਾਲ`, bold: true }, " ਤੱਕ ਯੋਗ ਹੈ ਜਿਸ ਲਈ ਨਿਮਨ ਅਨੁਸਾਰ ਹਦਾਇਤਾਂ ਹਨ।"],
                border: [true, false, true, false],
                alignment: "justify",
                preserveLeadingSpaces: true
