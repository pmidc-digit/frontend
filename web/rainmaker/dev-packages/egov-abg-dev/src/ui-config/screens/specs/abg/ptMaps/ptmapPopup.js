            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <div style={{ fontSize: "13px", color: "#757575", marginBottom: "6px", fontWeight: 500 }}>Building Name</div>
                        <div style={{ fontSize: "15px", fontWeight: 600, color: "#333" }}>{buildingName || "-"}</div>
                    </div>
