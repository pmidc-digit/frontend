...
export const renewTradelicence = async (financialYear, state, dispatch) => {
  ...
  if(licences[0].financialYear=='2019-20' || licences[0].financialYear=='2020-21' || licences[0].financialYear=='2021-22' || licences[0].financialYear=='2022-23' || licences[0].financialYear=='2023-24'){
