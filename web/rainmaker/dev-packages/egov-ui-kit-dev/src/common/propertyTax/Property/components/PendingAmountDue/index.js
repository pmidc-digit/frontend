          ...
          <div style={{ margin: 16 }}>
            ...
            <div>
              ...
              <div style={payNowButton} >
                ...
                {amount > 0 && <Button disabled={amount <= 0} className="pending-dues" style={buttonStyle} label={<Label buttonLabel={true} color= "rgb(41, 71, 163)"  label="CS_COMMON_PAY_NOW" fontSize="16px" />} onClick={() => { this.navigateToCommonPay(consumerCode, "PT") }}/>}
              </div>
            </div><br/>
            <div>
              <Label fontSize="18px" label="PT_WATER_BILL_DUE" />
              {
                waterDetails && waterDetails.length > 0 ? (waterDetails.map(items => {
                  if(items.module === "WS") {
                    return (
                      <div style={payNowButton} >
                        ...
                        <Button disabled={items.waterDue <= 0} className="pending-dues" style={buttonStyle} label={<Label buttonLabel={true} color= "rgb(41, 71, 163)"  label="CS_COMMON_PAY_NOW" fontSize="16px" />} onClick={() => { this.navigateToCommonPay(items.connectionNo, items.module) }}/>
                      </div>
                    )
                  }
                })
                  ...
                  <div style={payNowButton} >
                    ...
                    {amount > 0 && <Button disabled={true} className="pending-dues" style={buttonStyle} label={<Label buttonLabel={true} color= "rgb(41, 71, 163)"  label="CS_COMMON_PAY_NOW" fontSize="16px" />} onClick={() => { this.navigateToCommonPay(items.connectionNo, items.module) }}/>}
                  </div>
                )
              }
            </div><br/>
                  ...
                  if(items.module === "SW") {
                    return (
                      <div style={payNowButton} >
                        ...
                        <Button disabled={items.sewerDue <= 0} className="pending-dues" style={buttonStyle}  label={<Label buttonLabel={true} color= "rgb(41, 71, 163)"  label="CS_COMMON_PAY_NOW" fontSize="16px" />} onClick={() => { this.navigateToCommonPay(items.connectionNo, items.module) }}/>
                      </div>
                    )
                  }
                }) 
