                ...
                <div>
                    ...
                    <div className="col-sm-6 col-xs-12" style={{ marginBottom: 1, marginTop: 1 }}>
                        <div className="assess-history" style={{ float: "right" }}>
                            <Button
                                label={<Label buttonLabel={true} label={formWizardConstants[PROPERTY_FORM_PURPOSE.REASSESS].parentButton} color="rgb(41, 71, 163)" fontSize="16px" height="40px" labelStyle={labelStyle} />}
                            ...
                            ></Button>
                            <Button 
                                label={<Label buttonLabel={true} label={formWizardConstants[PROPERTY_FORM_PURPOSE.CANCEL].parentButton} color="rgb(41, 71, 163)" fontSize="16px" height="40px" labelStyle={labelStyle} />}
                                buttonStyle={buttonStyle}
                                onClick={() => {
                                    if (this.props.selPropertyDetails.status != "ACTIVE") {
                                        this.props.toggleSnackbarAndSetText(
