...
const StatusIcon = ({ status }) => {
  switch (status) {
    case "open":
    case "pending":
      return <Icon action="custom" name="file-plus" style={statusCommonIconStyle} color={"#2947a3"} />;
    case "reassignrequested":
      return <Icon action="custom" name="reassign-request" style={statusCommonIconStyle} color={"#2947a3"} />;
    case "assigned":
    case "re-assign":
      return <Icon action="custom" name="file-send" style={statusCommonIconStyle} color={"#2947a3"} />;
    case "rejected":
