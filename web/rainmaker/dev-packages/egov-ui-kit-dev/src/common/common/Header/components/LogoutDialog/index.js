...
const LogoutDialog = ({ logout, closeLogoutDialog, logoutPopupOpen, oktext, canceltext, title, body }) => {
  const actions = [
    <Button
      ...
      label={<Label buttonLabel={true} label={canceltext} color="#2947a3" />}
      backgroundColor={"#fff"}
    ...
    <Button
      ...
      label={<Label buttonLabel={true} label={oktext} color="#2947a3" />}
      backgroundColor={"#fff"}
      onClick={logout}
      style={{ boxShadow: "none" }}
    />,
  ...
  return (
    <Dialog
      ...
      children={[
        <Label label={body} color="#2947a3" labelStyle={{ padding: "16px 0px 0px 12px" }} />,
      ]}
