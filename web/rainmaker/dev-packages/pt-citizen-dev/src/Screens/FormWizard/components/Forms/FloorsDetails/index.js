  ...
  renderUnits = (units, floorId) => {
    ...
    return (
      <div>
        ...
        {!disabled && (
          <div className="pt-add-owner-btn" onClick={() => handleAddUnit(floorId)} style={{ color: "#2947a3", float: "right", cursor: "pointer" }}>
            <Label label="+" color="#2947a3" containerStyle={{ marginRight: 5 }} />
            <Label label="PT_ADD_UNIT" color="#2947a3" />
